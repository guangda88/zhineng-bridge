...
**文件**: `/home/ai/zhibridge/relay-server/models.py`
...
**文件**: `/home/ai/zhibridge/web/ui/index.html`
...
1. `/home/ai/zhibridge/relay-server/models.py` - Pydantic 模型配置
2. `/home/ai/zhibridge/web/ui/index.html` - 清理重复脚本标签
