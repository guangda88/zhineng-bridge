...
### 文件读取
```bash
curl "http://10.113.22.99:8080/api/files/read?path=/home/ai/zhibridge/relay-server/server.py"
```
...
### 文件列表
```bash
curl "http://10.113.22.99:8080/api/files/list?path=/home/ai/zhibridge/relay-server&limit=10"
```

### 文件统计
```bash
curl "http://10.113.22.99:8080/api/files/stats?path=/home/ai/zhibridge/relay-server/server.py"
```
