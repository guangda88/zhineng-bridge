...
class TestSession:
    ...
    def test_init(self):
        """测试 Session 初始化"""
        session = Session(
            session_id="test-session-id", tool_name="crush", args=["--help"], base_dir="/tmp"
        )
    ...
    def test_to_dict(self):
        ...
        session = Session(
            session_id="test-session-id", tool_name="cursor", args=["--version"], base_dir="/tmp"
        )
    ...
    def test_to_dict_all_fields(self):
        ...
        session = Session(
            session_id="test-123", tool_name="claude", args=["--help"], base_dir="/tmp/test"
        )
