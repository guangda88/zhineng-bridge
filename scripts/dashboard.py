...
class ServiceDashboard:
        ...
        for key, info in services_info.items():
            ...
            if info['running']:
                ...
                if info['port']:
                    ...
                    print(f"   端口: {port_icon} {info['port']} ({'监听' if info['port_ok'] else '未监听'})")
    ...
    def draw_metrics(self):
        ...
        try:
            ...
            print(f"  系统负载: {loadavg[0]:.2f} (1min) | {loadavg[1]:.2f} (5min) | {loadavg[2]:.2f} (15min)")
        except:
            print("  系统负载: N/A")
